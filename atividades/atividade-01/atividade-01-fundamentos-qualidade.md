...
> Observação sobre as evidências: a exploração foi feita em navegador desktop (1568 x 713 px de área visível), em 16/09/2026, com a conta de teste já autenticada na aplicação. Os registros descrevem somente o comportamento observado na interface; não houve acesso ao código ou ao banco de dados.
